...
{
    internal static unsafe partial class SPIRV
    {
...
#pragma warning disable IDE1006 // Naming Styles
        private static class Mac
        {
            ...
            private const i32 RTLD_LAZY = 1;
            private const i32 RTLD_NOW = 2;

            public static IntPtr dlopen(string path, bool lazy = true) =>
                dlopen(path, lazy ? RTLD_LAZY : RTLD_NOW);

            [DllImport(SystemLibrary)]
            public static extern IntPtr dlopen(string path, i32 mode);
