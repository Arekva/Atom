...
{
	internal unsafe partial class SPIRV
	{
		...
		private delegate void  PFN_spvc_get_version(u32* major, u32* minor, u32* patch);
		private static readonly PFN_spvc_get_version spvc_get_version_ = LoadFunction<PFN_spvc_get_version>(nameof(spvc_get_version));
		public static void spvc_get_version(u32* major, u32* minor, u32* patch)
		{
			spvc_get_version_(major, minor, patch);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_get_commit_revision_and_timestamp();
		...
		public static u8* spvc_get_commit_revision_and_timestamp()
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_msl_get_aux_buffer_struct_version();
		...
		public static u32 spvc_msl_get_aux_buffer_struct_version()
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_context_get_last_error_string(spvc_context context);
		...
		public static u8* spvc_context_get_last_error_string(spvc_context context)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_get_current_id_bound(spvc_compiler compiler);
		...
		public static u32 spvc_compiler_get_current_id_bound(spvc_compiler compiler)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_options_set_uint(spvc_compiler_options options, spvc_compiler_option option, u32 value);
		...
		public static spvc_result spvc_compiler_options_set_uint(spvc_compiler_options options, spvc_compiler_option option, u32 value)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_add_header_line(spvc_compiler compiler, u8* line);
		...
		public static spvc_result spvc_compiler_add_header_line(spvc_compiler compiler, u8* line)
		{
			return spvc_compiler_add_header_line_(compiler, line);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_require_extension(spvc_compiler compiler, u8* ext);
		...
		public static spvc_result spvc_compiler_require_extension(spvc_compiler compiler, u8* ext)
		{
			return spvc_compiler_require_extension_(compiler, ext);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_flatten_buffer_block(spvc_compiler compiler, u32 id);
		...
		public static spvc_result spvc_compiler_flatten_buffer_block(spvc_compiler compiler, u32 id)
		{
			return spvc_compiler_flatten_buffer_block_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_variable_is_depth_or_compare(spvc_compiler compiler, u32 id);
		...
		public static bool spvc_compiler_variable_is_depth_or_compare(spvc_compiler compiler, u32 id)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_hlsl_remap_num_workgroups_builtin(spvc_compiler compiler);
		...
		public static u32 spvc_compiler_hlsl_remap_num_workgroups_builtin(spvc_compiler compiler)
		{
			return spvc_compiler_hlsl_remap_num_workgroups_builtin_(compiler);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_hlsl_set_resource_binding_flags(spvc_compiler compiler, u32 flags);
		...
		public static spvc_result spvc_compiler_hlsl_set_resource_binding_flags(spvc_compiler compiler, u32 flags)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_hlsl_is_resource_used(spvc_compiler compiler, SpvExecutionModel model, u32 set, u32 binding);
		...
		public static bool spvc_compiler_hlsl_is_resource_used(spvc_compiler compiler, SpvExecutionModel model, u32 set, u32 binding)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_add_discrete_descriptor_set(spvc_compiler compiler, u32 desc_set);
		...
		public static spvc_result spvc_compiler_msl_add_discrete_descriptor_set(spvc_compiler compiler, u32 desc_set)
		{
			return spvc_compiler_msl_add_discrete_descriptor_set_(compiler, desc_set);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_set_argument_buffer_device_address_space(spvc_compiler compiler, u32 desc_set, bool device_address);
		...
		public static spvc_result spvc_compiler_msl_set_argument_buffer_device_address_space(spvc_compiler compiler, u32 desc_set, bool device_address)
		{
			return spvc_compiler_msl_set_argument_buffer_device_address_space_(compiler, desc_set, device_address);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_msl_is_vertex_attribute_used(spvc_compiler compiler, u32 location);
		...
		public static bool spvc_compiler_msl_is_vertex_attribute_used(spvc_compiler compiler, u32 location)
		{
			return spvc_compiler_msl_is_vertex_attribute_used_(compiler, location);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_msl_is_shader_input_used(spvc_compiler compiler, u32 location);
		...
		public static bool spvc_compiler_msl_is_shader_input_used(spvc_compiler compiler, u32 location)
		{
			return spvc_compiler_msl_is_shader_input_used_(compiler, location);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_msl_is_resource_used(spvc_compiler compiler, SpvExecutionModel model, u32 set, u32 binding);
		...
		public static bool spvc_compiler_msl_is_resource_used(spvc_compiler compiler, SpvExecutionModel model, u32 set, u32 binding)
		{
			return spvc_compiler_msl_is_resource_used_(compiler, model, set, binding);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_remap_constexpr_sampler(spvc_compiler compiler, u32 id, spvc_msl_constexpr_sampler* sampler);
		...
		public static spvc_result spvc_compiler_msl_remap_constexpr_sampler(spvc_compiler compiler, u32 id, spvc_msl_constexpr_sampler* sampler)
		{
			return spvc_compiler_msl_remap_constexpr_sampler_(compiler, id, sampler);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_remap_constexpr_sampler_by_binding(spvc_compiler compiler, u32 desc_set, u32 binding, spvc_msl_constexpr_sampler* sampler);
		...
		public static spvc_result spvc_compiler_msl_remap_constexpr_sampler_by_binding(spvc_compiler compiler, u32 desc_set, u32 binding, spvc_msl_constexpr_sampler* sampler)
		{
			return spvc_compiler_msl_remap_constexpr_sampler_by_binding_(compiler, desc_set, binding, sampler);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_remap_constexpr_sampler_ycbcr(spvc_compiler compiler, u32 id, spvc_msl_constexpr_sampler* sampler, spvc_msl_sampler_ycbcr_conversion* conv);
		...
		public static spvc_result spvc_compiler_msl_remap_constexpr_sampler_ycbcr(spvc_compiler compiler, u32 id, spvc_msl_constexpr_sampler* sampler, spvc_msl_sampler_ycbcr_conversion* conv)
		{
			return spvc_compiler_msl_remap_constexpr_sampler_ycbcr_(compiler, id, sampler, conv);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_remap_constexpr_sampler_by_binding_ycbcr(spvc_compiler compiler, u32 desc_set, u32 binding, spvc_msl_constexpr_sampler* sampler, spvc_msl_sampler_ycbcr_conversion* conv);
		...
		public static spvc_result spvc_compiler_msl_remap_constexpr_sampler_by_binding_ycbcr(spvc_compiler compiler, u32 desc_set, u32 binding, spvc_msl_constexpr_sampler* sampler, spvc_msl_sampler_ycbcr_conversion* conv)
		{
			return spvc_compiler_msl_remap_constexpr_sampler_by_binding_ycbcr_(compiler, desc_set, binding, sampler, conv);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_set_fragment_output_components(spvc_compiler compiler, u32 location, u32 components);
		...
		public static spvc_result spvc_compiler_msl_set_fragment_output_components(spvc_compiler compiler, u32 location, u32 components)
		{
			return spvc_compiler_msl_set_fragment_output_components_(compiler, location, components);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_msl_get_automatic_resource_binding(spvc_compiler compiler, u32 id);
		...
		public static u32 spvc_compiler_msl_get_automatic_resource_binding(spvc_compiler compiler, u32 id)
		{
			return spvc_compiler_msl_get_automatic_resource_binding_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_msl_get_automatic_resource_binding_secondary(spvc_compiler compiler, u32 id);
		...
		public static u32 spvc_compiler_msl_get_automatic_resource_binding_secondary(spvc_compiler compiler, u32 id)
		{
			return spvc_compiler_msl_get_automatic_resource_binding_secondary_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_add_dynamic_buffer(spvc_compiler compiler, u32 desc_set, u32 binding, u32 index);
		...
		public static spvc_result spvc_compiler_msl_add_dynamic_buffer(spvc_compiler compiler, u32 desc_set, u32 binding, u32 index)
		{
			return spvc_compiler_msl_add_dynamic_buffer_(compiler, desc_set, binding, index);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_add_inline_uniform_block(spvc_compiler compiler, u32 desc_set, u32 binding);
		...
		public static spvc_result spvc_compiler_msl_add_inline_uniform_block(spvc_compiler compiler, u32 desc_set, u32 binding)
		{
			return spvc_compiler_msl_add_inline_uniform_block_(compiler, desc_set, binding);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_msl_set_combined_sampler_suffix(spvc_compiler compiler, u8* suffix);
		...
		public static spvc_result spvc_compiler_msl_set_combined_sampler_suffix(spvc_compiler compiler, u8* suffix)
		{
			return spvc_compiler_msl_set_combined_sampler_suffix_(compiler, suffix);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_compiler_msl_get_combined_sampler_suffix(spvc_compiler compiler);
		...
		public static u8* spvc_compiler_msl_get_combined_sampler_suffix(spvc_compiler compiler)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_set_decoration(spvc_compiler compiler, SpvId id, SpvDecoration decoration, u32 argument);
		...
		public static void spvc_compiler_set_decoration(spvc_compiler compiler, SpvId id, SpvDecoration decoration, u32 argument)
		{
			spvc_compiler_set_decoration_(compiler, id, decoration, argument);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_set_decoration_string(spvc_compiler compiler, SpvId id, SpvDecoration decoration, u8* argument);
		...
		public static void spvc_compiler_set_decoration_string(spvc_compiler compiler, SpvId id, SpvDecoration decoration, u8* argument)
		{
			spvc_compiler_set_decoration_string_(compiler, id, decoration, argument);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_set_name(spvc_compiler compiler, SpvId id, u8* argument);
		...
		public static void spvc_compiler_set_name(spvc_compiler compiler, SpvId id, u8* argument)
		{
			spvc_compiler_set_name_(compiler, id, argument);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_set_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration, u32 argument);
		...
		public static void spvc_compiler_set_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration, u32 argument)
		{
			spvc_compiler_set_member_decoration_(compiler, id, member_index, decoration, argument);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_set_member_decoration_string(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration, u8* argument);
		...
		public static void spvc_compiler_set_member_decoration_string(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration, u8* argument)
		{
			spvc_compiler_set_member_decoration_string_(compiler, id, member_index, decoration, argument);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_set_member_name(spvc_compiler compiler, u32 id, u32 member_index, u8* argument);
		...
		public static void spvc_compiler_set_member_name(spvc_compiler compiler, u32 id, u32 member_index, u8* argument)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_unset_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration);
		...
		public static void spvc_compiler_unset_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_has_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration);
		...
		public static bool spvc_compiler_has_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration)
		{
			return spvc_compiler_has_member_decoration_(compiler, id, member_index, decoration);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_compiler_get_name(spvc_compiler compiler, SpvId id);
		...
		public static u8* spvc_compiler_get_name(spvc_compiler compiler, SpvId id)
		{
			return spvc_compiler_get_name_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_get_decoration(spvc_compiler compiler, SpvId id, SpvDecoration decoration);
		...
		public static u32 spvc_compiler_get_decoration(spvc_compiler compiler, SpvId id, SpvDecoration decoration)
		{
			return spvc_compiler_get_decoration_(compiler, id, decoration);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_compiler_get_decoration_string(spvc_compiler compiler, SpvId id, SpvDecoration decoration);
		...
		public static u8* spvc_compiler_get_decoration_string(spvc_compiler compiler, SpvId id, SpvDecoration decoration)
		{
			return spvc_compiler_get_decoration_string_(compiler, id, decoration);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_get_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration);
		...
		public static u32 spvc_compiler_get_member_decoration(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration)
		{
			return spvc_compiler_get_member_decoration_(compiler, id, member_index, decoration);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_compiler_get_member_decoration_string(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration);
		...
		public static u8* spvc_compiler_get_member_decoration_string(spvc_compiler compiler, u32 id, u32 member_index, SpvDecoration decoration)
		{
			return spvc_compiler_get_member_decoration_string_(compiler, id, member_index, decoration);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_compiler_get_member_name(spvc_compiler compiler, u32 id, u32 member_index);
		...
		public static u8* spvc_compiler_get_member_name(spvc_compiler compiler, u32 id, u32 member_index)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_set_entry_point(spvc_compiler compiler, u8* name, SpvExecutionModel model);
		...
		public static spvc_result spvc_compiler_set_entry_point(spvc_compiler compiler, u8* name, SpvExecutionModel model)
		{
			return spvc_compiler_set_entry_point_(compiler, name, model);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_rename_entry_point(spvc_compiler compiler, u8* old_name, u8* new_name, SpvExecutionModel model);
		...
		public static spvc_result spvc_compiler_rename_entry_point(spvc_compiler compiler, u8* old_name, u8* new_name, SpvExecutionModel model)
		{
			return spvc_compiler_rename_entry_point_(compiler, old_name, new_name, model);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_compiler_get_cleansed_entry_point_name(spvc_compiler compiler, u8* name, SpvExecutionModel model);
		...
		public static u8* spvc_compiler_get_cleansed_entry_point_name(spvc_compiler compiler, u8* name, SpvExecutionModel model)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_compiler_set_execution_mode_with_arguments(spvc_compiler compiler, SpvExecutionMode mode, u32 arg0, u32 arg1, u32 arg2);
		...
		public static void spvc_compiler_set_execution_mode_with_arguments(spvc_compiler compiler, SpvExecutionMode mode, u32 arg0, u32 arg1, u32 arg2)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_get_execution_mode_argument(spvc_compiler compiler, SpvExecutionMode mode);
		...
		public static u32 spvc_compiler_get_execution_mode_argument(spvc_compiler compiler, SpvExecutionMode mode)
		{
			return spvc_compiler_get_execution_mode_argument_(compiler, mode);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_get_execution_mode_argument_by_index(spvc_compiler compiler, SpvExecutionMode mode, u32 index);
		...
		public static u32 spvc_compiler_get_execution_mode_argument_by_index(spvc_compiler compiler, SpvExecutionMode mode, u32 index)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_type  PFN_spvc_compiler_get_type_handle(spvc_compiler compiler, u32 id);
		...
		public static spvc_type spvc_compiler_get_type_handle(spvc_compiler compiler, u32 id)
		{
			return spvc_compiler_get_type_handle_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_base_type_id(spvc_type type);
		...
		public static u32 spvc_type_get_base_type_id(spvc_type type)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_bit_width(spvc_type type);
		...
		public static u32 spvc_type_get_bit_width(spvc_type type)
		{
			return spvc_type_get_bit_width_(type);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_vector_size(spvc_type type);
		...
		public static u32 spvc_type_get_vector_size(spvc_type type)
		{
			return spvc_type_get_vector_size_(type);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_columns(spvc_type type);
		...
		public static u32 spvc_type_get_columns(spvc_type type)
		{
			return spvc_type_get_columns_(type);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_num_array_dimensions(spvc_type type);
		...
		public static u32 spvc_type_get_num_array_dimensions(spvc_type type)
		{
			return spvc_type_get_num_array_dimensions_(type);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_type_array_dimension_is_literal(spvc_type type, u32 dimension);
		...
		public static bool spvc_type_array_dimension_is_literal(spvc_type type, u32 dimension)
		{
			return spvc_type_array_dimension_is_literal_(type, dimension);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate SpvId  PFN_spvc_type_get_array_dimension(spvc_type type, u32 dimension);
		...
		public static SpvId spvc_type_get_array_dimension(spvc_type type, u32 dimension)
		{
			return spvc_type_get_array_dimension_(type, dimension);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_num_member_types(spvc_type type);
		...
		public static u32 spvc_type_get_num_member_types(spvc_type type)
		{
			return spvc_type_get_num_member_types_(type);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_member_type(spvc_type type, u32 index);
		...
		public static u32 spvc_type_get_member_type(spvc_type type, u32 index)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_type_get_image_sampled_type(spvc_type type);
		...
		public static u32 spvc_type_get_image_sampled_type(spvc_type type)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_get_declared_struct_member_size(spvc_compiler compiler, spvc_type type, u32 index, nuint* size);
		...
		public static spvc_result spvc_compiler_get_declared_struct_member_size(spvc_compiler compiler, spvc_type type, u32 index, nuint* size)
		{
			return spvc_compiler_get_declared_struct_member_size_(compiler, type, index, size);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_type_struct_member_offset(spvc_compiler compiler, spvc_type type, u32 index, u32* offset);
		...
		public static spvc_result spvc_compiler_type_struct_member_offset(spvc_compiler compiler, spvc_type type, u32 index, u32* offset)
		{
			return spvc_compiler_type_struct_member_offset_(compiler, type, index, offset);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_type_struct_member_array_stride(spvc_compiler compiler, spvc_type type, u32 index, u32* stride);
		...
		public static spvc_result spvc_compiler_type_struct_member_array_stride(spvc_compiler compiler, spvc_type type, u32 index, u32* stride)
		{
			return spvc_compiler_type_struct_member_array_stride_(compiler, type, index, stride);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_type_struct_member_matrix_stride(spvc_compiler compiler, spvc_type type, u32 index, u32* stride);
		...
		public static spvc_result spvc_compiler_type_struct_member_matrix_stride(spvc_compiler compiler, spvc_type type, u32 index, u32* stride)
		{
			return spvc_compiler_type_struct_member_matrix_stride_(compiler, type, index, stride);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_build_dummy_sampler_for_combined_images(spvc_compiler compiler, u32* id);
		...
		public static spvc_result spvc_compiler_build_dummy_sampler_for_combined_images(spvc_compiler compiler, u32* id)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_constant  PFN_spvc_compiler_get_constant_handle(spvc_compiler compiler, u32 id);
		...
		public static spvc_constant spvc_compiler_get_constant_handle(spvc_compiler compiler, u32 id)
		{
			return spvc_compiler_get_constant_handle_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_compiler_get_work_group_size_specialization_constants(spvc_compiler compiler, spvc_specialization_constant* x, spvc_specialization_constant* y, spvc_specialization_constant* z);
		...
		public static u32 spvc_compiler_get_work_group_size_specialization_constants(spvc_compiler compiler, spvc_specialization_constant* x, spvc_specialization_constant* y, spvc_specialization_constant* z)
		{
			return spvc_compiler_get_work_group_size_specialization_constants_(compiler, x, y, z);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_get_active_buffer_ranges(spvc_compiler compiler, u32 id, spvc_buffer_range* ranges, nuint* num_ranges);
		...
		public static spvc_result spvc_compiler_get_active_buffer_ranges(spvc_compiler compiler, u32 id, spvc_buffer_range* ranges, nuint* num_ranges)
		{
			return spvc_compiler_get_active_buffer_ranges_(compiler, id, ranges, num_ranges);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate float  PFN_spvc_constant_get_scalar_fp16(spvc_constant constant, u32 column, u32 row);
		...
		public static float spvc_constant_get_scalar_fp16(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_fp16_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate float  PFN_spvc_constant_get_scalar_fp32(spvc_constant constant, u32 column, u32 row);
		...
		public static float spvc_constant_get_scalar_fp32(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_fp32_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate double  PFN_spvc_constant_get_scalar_fp64(spvc_constant constant, u32 column, u32 row);
		...
		public static double spvc_constant_get_scalar_fp64(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_fp64_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_constant_get_scalar_u32(spvc_constant constant, u32 column, u32 row);
		...
		public static u32 spvc_constant_get_scalar_u32(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_u32_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate i32  PFN_spvc_constant_get_scalar_i32(spvc_constant constant, u32 column, u32 row);
		...
		public static i32 spvc_constant_get_scalar_i32(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_i32_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_constant_get_scalar_u16(spvc_constant constant, u32 column, u32 row);
		...
		public static u32 spvc_constant_get_scalar_u16(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_u16_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate i32  PFN_spvc_constant_get_scalar_i16(spvc_constant constant, u32 column, u32 row);
		...
		public static i32 spvc_constant_get_scalar_i16(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_i16_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_constant_get_scalar_u8(spvc_constant constant, u32 column, u32 row);
		...
		public static u32 spvc_constant_get_scalar_u8(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_u8_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate i32  PFN_spvc_constant_get_scalar_i8(spvc_constant constant, u32 column, u32 row);
		...
		public static i32 spvc_constant_get_scalar_i8(spvc_constant constant, u32 column, u32 row)
		{
			return spvc_constant_get_scalar_i8_(constant, column, row);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void  PFN_spvc_constant_get_subconstants(spvc_constant constant, u32* constituents, nuint* count);
		...
		public static void spvc_constant_get_subconstants(spvc_constant constant, u32* constituents, nuint* count)
		{
			spvc_constant_get_subconstants_(constant, constituents, count);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u32  PFN_spvc_constant_get_type(spvc_constant constant);
		...
		public static u32 spvc_constant_get_type(spvc_constant constant)
		{
			return spvc_constant_get_type_(constant);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_get_binary_offset_for_decoration(spvc_compiler compiler, u32 id, SpvDecoration decoration, u32* word_offset);
		...
		public static bool spvc_compiler_get_binary_offset_for_decoration(spvc_compiler compiler, u32 id, SpvDecoration decoration, u32* word_offset)
		{
			return spvc_compiler_get_binary_offset_for_decoration_(compiler, id, decoration, word_offset);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_buffer_is_hlsl_counter_buffer(spvc_compiler compiler, u32 id);
		...
		public static bool spvc_compiler_buffer_is_hlsl_counter_buffer(spvc_compiler compiler, u32 id)
		{
			return spvc_compiler_buffer_is_hlsl_counter_buffer_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate bool  PFN_spvc_compiler_buffer_get_hlsl_counter_buffer(spvc_compiler compiler, u32 id, u32* counter_id);
		...
		public static bool spvc_compiler_buffer_get_hlsl_counter_buffer(spvc_compiler compiler, u32 id, u32* counter_id)
		{
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_get_declared_extensions(spvc_compiler compiler, u8* extensions, nuint* num_extensions);
		...
		public static spvc_result spvc_compiler_get_declared_extensions(spvc_compiler compiler, u8* extensions, nuint* num_extensions)
		{
			return spvc_compiler_get_declared_extensions_(compiler, extensions, num_extensions);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate u8*  PFN_spvc_compiler_get_remapped_declared_block_name(spvc_compiler compiler, u32 id);
		...
		public static u8* spvc_compiler_get_remapped_declared_block_name(spvc_compiler compiler, u32 id)
		{
			return spvc_compiler_get_remapped_declared_block_name_(compiler, id);
		}

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate spvc_result  PFN_spvc_compiler_get_buffer_block_decorations(spvc_compiler compiler, u32 id, SpvDecoration* decorations, nuint* num_decorations);
		...
		public static spvc_result spvc_compiler_get_buffer_block_decorations(spvc_compiler compiler, u32 id, SpvDecoration* decorations, nuint* num_decorations)
		{
