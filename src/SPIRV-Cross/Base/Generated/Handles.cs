...
namespace SPIRVCross.Base
{
	...
	/// </summary>
	[DebuggerDisplay("{DebuggerDisplay,nq}")]
	internal readonly partial struct spvc_parsed_ir : IEquatable<spvc_parsed_ir>
	{
	...
	/// </summary>
	[DebuggerDisplay("{DebuggerDisplay,nq}")]
	internal readonly partial struct spvc_resources : IEquatable<spvc_resources>
	{
	...
	/// </summary>
	[DebuggerDisplay("{DebuggerDisplay,nq}")]
	internal readonly partial struct spvc_constant : IEquatable<spvc_constant>
	{
	...
	/// </summary>
	[DebuggerDisplay("{DebuggerDisplay,nq}")]
	internal readonly partial struct spvc_set : IEquatable<spvc_set>
	{
	...
	/// </summary>
	[DebuggerDisplay("{DebuggerDisplay,nq}")]
	internal readonly partial struct spvc_error_callback : IEquatable<spvc_error_callback>
	{
