...
{
	internal enum SpvSourceLanguage
	{
	...
	internal enum SpvExecutionModel
	{
	...
	internal enum SpvAddressingModel
	{
	...
	internal enum SpvExecutionMode
	{
	...
	internal enum SpvSamplerAddressingMode
	{
	...
	internal enum SpvSamplerFilterMode
	{
	...
	internal enum SpvImageChannelOrder
	{
	...
	internal enum SpvImageChannelDataType
	{
	...
	internal enum SpvImageOperandsShift
	{
	...
	internal enum SpvImageOperandsMask
	{
	...
	internal enum SpvFPFastMathModeShift
	{
	...
	internal enum SpvFPFastMathModeMask
	{
	...
	internal enum SpvFPRoundingMode
	{
	...
	internal enum SpvAccessQualifier
	{
	...
	internal enum SpvFunctionParameterAttribute
	{
	...
	internal enum SpvSelectionControlShift
	{
	...
	internal enum SpvSelectionControlMask
	{
	...
	internal enum SpvLoopControlShift
	{
	...
	internal enum SpvLoopControlMask
	{
	...
	internal enum SpvFunctionControlShift
	{
	...
	internal enum SpvFunctionControlMask
	{
	...
	internal enum SpvMemorySemanticsShift
	{
	...
	internal enum SpvMemorySemanticsMask
	{
	...
	internal enum SpvMemoryAccessShift
	{
	...
	internal enum SpvMemoryAccessMask
	{
	...
	internal enum SpvGroupOperation
	{
	...
	internal enum SpvKernelEnqueueFlags
	{
	...
	internal enum SpvKernelProfilingInfoShift
	{
		SpvKernelProfilingInfoCmdExecTimeShift = 0,
		SpvKernelProfilingInfoMax = 2147483647,
	}

	internal enum SpvKernelProfilingInfoMask
	{
		SpvKernelProfilingInfoMaskNone = 0,
		SpvKernelProfilingInfoCmdExecTimeMask = 1,
	}

	internal enum SpvCapability
	{
	...
	internal enum SpvRayFlagsShift
	{
	...
	internal enum SpvRayQueryIntersection
	{
	...
	internal enum SpvRayQueryCommittedIntersectionType
	{
	...
	internal enum SpvRayQueryCandidateIntersectionType
	{
	...
	internal enum SpvFragmentShadingRateShift
	{
	...
	internal enum SpvFragmentShadingRateMask
	{
	...
	internal enum spvc_capture_mode
	{
		Copy = 0,
		TakeOwnership = 1,
		IntMax = 2147483647,
	...
	internal enum spvc_resource_type
	{
		Unknown = 0,
		UniformBuffer = 1,
		StorageBuffer = 2,
	...
	internal enum spvc_msl_platform
	{
		Ios = 0,
		Macos = 1,
		MaxInt = 2147483647,
	...
	internal enum spvc_msl_index_type
	{
		None = 0,
		Uint16 = 1,
		Uint32 = 2,
	...
	internal enum spvc_msl_vertex_format
	{
		Other = 0,
		Uint8 = 1,
		Uint16 = 2,
	...
	internal enum spvc_msl_shader_input_format
	{
		Other = 0,
		Uint8 = 1,
		Uint16 = 2,
	...
	internal enum spvc_msl_sampler_coord
	{
		Normalized = 0,
		Pixel = 1,
	...
	internal enum spvc_msl_sampler_filter
	{
		Nearest = 0,
		Linear = 1,
		IntMax = 2147483647,
	...
	internal enum spvc_msl_sampler_mip_filter
	{
		None = 0,
		Nearest = 1,
		Linear = 2,
	...
	internal enum spvc_msl_sampler_address
	{
		ClampToZero = 0,
		ClampToEdge = 1,
		ClampToBorder = 2,
	...
	internal enum spvc_msl_sampler_compare_func
	{
		Never = 0,
		Less = 1,
		LessEqual = 2,
	...
	internal enum spvc_msl_sampler_border_color
	{
		TransparentBlack = 0,
		OpaqueBlack = 1,
		OpaqueWhite = 2,
	...
	internal enum spvc_msl_format_resolution
	{
		_444 = 0,
		_422 = 1,
		_420 = 2,
	...
	internal enum spvc_msl_chroma_location
	{
		CositedEven = 0,
		Midpoint = 1,
		IntMax = 2147483647,
	...
	internal enum spvc_msl_component_swizzle
	{
		Identity = 0,
		Zero = 1,
		One = 2,
	...
	internal enum spvc_msl_sampler_ycbcr_model_conversion
	{
		RgbIdentity = 0,
		YcbcrIdentity = 1,
		YcbcrBt709 = 2,
	...
	internal enum spvc_msl_sampler_ycbcr_range
	{
		ItuFull = 0,
		ItuNarrow = 1,
		IntMax = 2147483647,
	...
	internal enum spvc_hlsl_binding_flag_bits
	{
	...
	internal enum spvc_compiler_option
	{
		Unknown = 0,
